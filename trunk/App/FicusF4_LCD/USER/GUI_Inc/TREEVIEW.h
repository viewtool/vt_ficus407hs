...
TREEVIEW_ITEM_Handle TREEVIEW_ITEM_Create     (int IsNode, const char * s, uint32_t UserData);
...
uint32_t                  TREEVIEW_ITEM_GetUserData(TREEVIEW_ITEM_Handle hItem);
...
void                 TREEVIEW_ITEM_SetUserData(TREEVIEW_ITEM_Handle hItem, uint32_t UserData);
