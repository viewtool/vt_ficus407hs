...
void             LISTVIEW_GetItemRect         (LISTVIEW_Handle hObj, uint32_t Col, uint32_t Row, GUI_RECT * pRect);
...
uint32_t              LISTVIEW_GetUserDataRow      (LISTVIEW_Handle hObj, unsigned Row);
...
void             LISTVIEW_SetUserDataRow      (LISTVIEW_Handle hObj, unsigned Row, uint32_t UserData);
